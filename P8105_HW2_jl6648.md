...
dataset contains 1948 observations and id, baseline, time, value
variabls. Pivot_longer is used to make the data longer instead of wider.
The “study id” in the “mci_amyloid.csv” dataset is inconsistent, so it
is renamed to “id”. It is the cue to find the participate appeared in
both dataset.
...
on the id variable, such as id 14 only appear in baseline dataset. After
joining two dataset together, dataset contains 360 observations and id,
current_age, sex, education, apoe4, age_at_onset, baseline, time, value
variables. Specificlly 90 number of participants appears in both
dataset.
