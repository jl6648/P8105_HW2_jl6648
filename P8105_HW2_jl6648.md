...
joining two dataset together, dataset contains 2355 observations and id,
current_age, sex, education, apoe4, age_at_onset, time, value variables.
Specificlly 471 number of participants appears in both dataset.
