...
Some participants appear in only the baseline or amyloid dataset based on the id variable, such as id 14 only appear in baseline dataset. After joining two dataset together, dataset contains `r nrow(participant_combine)` observations, specificlly `r nrow(participant_combine)/4` number of participants appears in both dataset. 